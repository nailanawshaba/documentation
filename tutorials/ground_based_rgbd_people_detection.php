...
<h1>The code</h1>
<p>You can download the source code for this tutorial from <a class="reference download internal" href="_downloads/main_ground_based_people_detection.cpp" download=""><code class="xref download docutils literal notranslate"><span class="pre">here</span></code></a>,
while the file containing the needed SVM parameters can be found <a class="reference download internal" href="_downloads/trainedLinearSVMForPeopleDetectionWithHOG.yaml" download=""><code class="xref download docutils literal notranslate"><span class="pre">here</span></code></a>.
