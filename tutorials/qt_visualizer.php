...
<p>Re-use the <a class="reference download internal" href="_downloads/CMakeLists1.txt" download=""><code class="xref download docutils literal notranslate"><span class="pre">CMakeLists.txt</span></code></a> from this tutorial if you want to compile the application outside of PCL.</p>
</div>
</div>
